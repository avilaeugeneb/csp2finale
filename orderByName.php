<?php
	...
	$_SESSION['product_qry'] = "SELECT p.id,p.pName,p.pDesc,p.pImage,p.pStocks,p.pPrice,c.cName FROM products p JOIN categories c ON(p.pCategoryID = c.id) ORDER BY pName";
